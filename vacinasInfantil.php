...
$sql = "SELECT vacina, protecao_contra, composicao, numero_de_doses, idade_recomendada, intervalo_entre_as_doses, esquema_basico, reforco_recomendado, minimo FROM vacinas_infanto";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>" . $row["numero_de_doses"]. "</td>
                        <td>" . $row["idade_recomendada"]. "</td>
                        <td>" . $row["intervalo_entre_as_doses"]. "</td>
                        <td>" . $row["esquema_basico"]. "</td>
                        <td>" . $row["reforco_recomendado"]. "</td>
                        <td>" . $row["minimo"]. "</td>
                    </tr>";
            }
        } else {
