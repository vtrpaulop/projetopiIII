...
<i class="fa-solid fa-hospital-user c-card__icon"></i>
                    ...
                    <img src="/public/assets/images/about-us.png" alt="">
                    </div>
            </div>
        </div>
    </section>
        ...
        <div class="c-screen__width">
            <div class="c-component c-date">
                <div class="c-component__description">
                    ...
                    <div class="c-component__image">
                    <img src="/public/assets/images/date.png" alt="">
                    </div>
            </div>
        </div>
    </section>
    ...
    <section class="c-section__board">
        <div class="c-screen__width">
            <div class="c-board">
                ...
                <img src="/public/assets/images/univesp-logo.png" alt="Univesp Logo" class="c-board__image">
            </div>
        </div>
    </section>
